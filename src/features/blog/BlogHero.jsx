  ...
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-night pt-32 pb-20">
      ...
      <motion.div
        ...
        className="absolute top-20 right-20 w-96 h-96 bg-blue/20 rounded-full blur-3xl"
      />
      <motion.div
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-6 py-2 mb-8 rounded-full bg-blue/10 border border-blue/30 text-blue text-sm font-medium"
          >
            <BookOpen size={16} />
            Our Blog
          </motion.div>
